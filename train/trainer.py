...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        n_samples = len(eval_dataset['input_ids'] if eval_dataset is not None else self.eval_dataset)
    ...
    def prediction_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            metrics['total_num'] += inputs['input_ids'].size(0)
        ...
        metrics["eval_accuracy"] = metrics["correct_num"] / metrics["total_num"]
        metrics["loss"] = metrics["loss"] / it

        logger.info(f'Loss: {metrics["loss"]}')
        logger.info(f'Accuracy: {metrics["eval_accuracy"]}')
        return metrics
    ...
    def prediction_step(
        ...
        with torch.no_grad():
            ...
            outputs["correct_num"] = outputs["correct_num"].sum().detach().cpu().item()
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        self._globalstep_last_evaluate = 0
